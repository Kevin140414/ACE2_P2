...
public class TakeShowerWindow extends AppCompatActivity {
    TextView tvDato;
    TextView tvInfo;
    TextView tvInfConex;
    TextView tvInfoDist;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.take_a_shower);
        inicializar();
    }
    ...
    private void inicializar() {
        ...
        btnManual.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                tvInfMode.setText("Control del vehiculo: Manual");
        ...
        btnAutomatic.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                tvInfMode.setText("Control del vehiculo: Automatico");
                tvInfo.setText("Value sent = a");
                sendMessage("a");
            }
        });
            ...
            switch (msg.what) {
                ...
                case Mensaje_Leido:
                    ...
                    if ( penultimoMsg.equals( "@" ) ){
                        penultimoMsg = "";
                        tvInfoDist.setText( readMessage + " cm.");
                    }
                    else if ( penultimoMsg == "#" ){
                        penultimoMsg = "";
                        tvInfObj.setText( readMessage );
                    }
